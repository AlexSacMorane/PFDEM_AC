...
def Sort_Files(dict_algorithm):
     ...
     #master simulation
     os.rename('PF_'+str(dict_algorithm['i_PF'])+'_out.e','Output/PF_'+str(dict_algorithm['i_PF'])+'_out.e')
     os.rename('PF_'+str(dict_algorithm['i_PF'])+'.i','Input/PF_'+str(dict_algorithm['i_PF'])+'.i')
     os.mkdir('Output/PF_'+str(dict_algorithm['i_PF']))
     j = 0
     j_str = index_to_str(j)
     folderpath = Path('PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'.pvtu')
     while folderpath.exists():
         for i_proc in range(dict_algorithm['np_proc']):
            os.rename('PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'_'+str(i_proc)+'.vtu','Output/PF_'+str(dict_algorithm['i_PF'])+'/PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'_'+str(i_proc)+'.vtu')
         os.rename('PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'.pvtu','Output/PF_'+str(dict_algorithm['i_PF'])+'/PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'.pvtu')
         j = j + 1
         j_str = index_to_str(j)
         folderpath = Path('PF_'+str(dict_algorithm['i_PF'])+'_other_'+j_str+'.pvtu')
